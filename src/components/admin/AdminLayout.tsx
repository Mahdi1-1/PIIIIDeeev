  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex">
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-2">
          {navItems.map((item) => (
            <div key={item.id}>
              ...
              {item.divider && <div className="h-px bg-[var(--border-default)] my-2" />}
            </div>
          ))}
        </nav>
      ...
      {mobileMenuOpen && (
        ...
        >
          <aside
            className="w-64 h-full bg-[var(--surface-1)] border-r border-[var(--border-default)]"
          ...
          >
            ...
            <nav className="overflow-y-auto py-4 px-2 h-[calc(100%-4rem)]">
              {navItems.map((item) => (
                <div key={item.id}>
                  <Link
                    to={item.href}
